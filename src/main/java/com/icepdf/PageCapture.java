...
public class PageCapture {
	// http://www.iaeng.org/publication/IMECS2011/IMECS2011_pp283-286.pdf
	static String outputPath = "D:\\TEMP\\pdfOutput\\dicom\\";

    public static void main(String[] args) {
        // Get a file from the command line to open
        String filePath = "D:\\TEMP\\pdfOutput\\dicom\\reportViewer2.pdf";
    ...
    public class CapturePage implements Callable<Void> {
		...
		public Void call() {
            try {
                ...
                File file = new File(outputPath, "imageCapture_" + pageNumber + ".jpg");
